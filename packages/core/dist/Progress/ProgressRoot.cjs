...
var ProgressRoot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const isIndeterminate = (0, vue.computed)(() => require_shared_nullish.isNullish(modelValue.value));
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), {
				...
				"aria-valuetext": isNumber((0, vue.unref)(modelValue)) ? _ctx.getValueLabel((0, vue.unref)(modelValue), (0, vue.unref)(max)) : void 0,
				role: "progressbar",
