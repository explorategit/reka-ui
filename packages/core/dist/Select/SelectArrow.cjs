...
var SelectArrow_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return (0, vue.unref)(contentContext).position === "popper" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Popper_PopperArrow.PopperArrow_default), (0, vue.normalizeProps)((0, vue.mergeProps)({ key: 0 }, props)), {
